...
from megatron.bridge.recipes.qwen.qwen3_moe import (
    qwen3_30b_a3b_pretrain_config as pretrain_config,
)
...
def parse_cli_args() -> Tuple[argparse.Namespace, list[str]]:
    ...
    parser = argparse.ArgumentParser(
        description="Pretrain Qwen3 MoE 30B-A3B model using Megatron-Bridge with YAML and CLI overrides",
...
def main() -> None:
    ...
    # Handle per-split data args if provided
    if args.per_split_data_args_path:
