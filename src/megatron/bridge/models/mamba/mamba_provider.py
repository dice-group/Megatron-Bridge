...
def _get_router_class(routing_type: str):
    ...
    elif routing_type == "et":
        from megatron.core.transformer.moe.gate import ETRouter
        return ETRouter
    elif routing_type == "topp":
        from megatron.core.transformer.moe.gate import TopPRouter
        return TopPRouter
