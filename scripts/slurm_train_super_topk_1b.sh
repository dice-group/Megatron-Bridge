...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-/scratch/hpc-prf-merlin/luke/Megatron-Bridge/checkpoints_topk}"
RUN_NAME="${RUN_NAME:-super_topk_1b}"
...
echo "Model     : Nemotron-3 Super 1B (Top-K MoE)"
