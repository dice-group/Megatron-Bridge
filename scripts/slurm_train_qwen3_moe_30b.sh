...
CHECKPOINT_DIR=/scratch/hpc-prf-merlin/luke/Megatron-Bridge/checkpoints_qwen3_moe_30b
...
# Parallelism — Qwen3 MoE 30B-A3B (48 layers, 128 experts)
...
if [ "${GPU_CC:-0}" -ge 89 ]; then
    ...
    # A100 40GB: quarter micro batch size to fit in VRAM, increase grad accum to preserve GBS
...
echo "Model     : Qwen3 MoE 30B-A3B (48 layers, 128 experts, top-8)"
echo "=============================="
